...
function switch_coach_match_equipe($id_coach1, $id_coach2, $id_match, $c){
    //insertion des valeurs dans la bdd
    $sql = ("UPDATE matchs_equipes_coachs SET id_coachs='$id_coach2' WHERE id_matchs='$id_match' AND id_coachs='$id_coach1' ");
    if(mysqli_query($c,$sql)){
        return true;
    }
    else{
